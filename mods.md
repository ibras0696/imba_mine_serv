...
* **Тип:** Server + Client
* **Функция:** компактные RPG структуры
* **Зависимости:** нет

## 3. Structure Gel API

* **Тип:** Server + Client
* **Функция:** библиотека для структурных модов
* **Зависимости:** нет

## 4. YUNG's Better Series
...
* **Тип:** Server + Client
* **Функция:** большой RPG мод (измерения, мобы, боссы)
* **Зависимости:** нет
...
* **Тип:** Client-only
* **Описание:** показ рецептов (для авто-кнопок можно ставить и на сервер)
* **Зависимости:** нет
